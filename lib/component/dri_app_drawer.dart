...
import 'package:rentit_app/screens/dri_dashboard.dart';
...
class DriAppDrawer extends StatefulWidget {

  @override
  _DriAppDrawerState createState() => _DriAppDrawerState();
}

class _DriAppDrawerState extends State<DriAppDrawer> {
  String url = '';
      ...
      child: ListView(
        ...
        children: [
          ...
          _createDrawerItem(icon: Icons.home, text: 'Home',
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context)=>DriverWelcomeScreen()))),

          _createDrawerItem(icon: Icons.category, text: 'My Dashboard',
              onTap: () => Navigator.push(context,MaterialPageRoute(builder: (context)=>DriDashboard()))),
